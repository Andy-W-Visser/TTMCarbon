...
LP1bottom = sum(lp1.*M1000,3);
FP1bottom = sum(fp1.*M1000,3);
...
colorbar
title('First passage time from 1000 m depth (year)')
...
geoshow('landareas.shp','FaceColor','#EEE8AA')
colorbar
title('Last passage time to 1000 m depth (year)')